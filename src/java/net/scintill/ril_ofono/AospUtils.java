...
public class AospUtils {
    ...
    /*
     * From libcore.reflect.Types in CM12. The build tool needs it because it has access to
     * neither libcore nor JDK 1.8, which defines a similar method in the reflect.Type interface.
     *
